...
public class AES_Algorithm {
        ...
        public static void main(String[] args) throws Exception {
            ...
            while (true) {
                System.out.print("\nEnter your Name: ");
                plainText= scanner.nextLine().trim();
                try {

                    if (plainText.matches("[A-Za-z]+( [A-Za-z]+)*")) {
                        // Exit loop if valid
                        break;
                    } else {
                        System.out.println("Error: Invalid plain text");
                    }

                } catch (NumberFormatException e) {
                    System.out.println("Error: Invalid input! Enter a valid text ");
