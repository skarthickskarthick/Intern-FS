...
public class Set_Stream_Operations {
    public static void main(String args[])
    {
        Set<Integer> integersList=new HashSet<Integer>(Arrays.asList(101, -22, -3, 40, -500, 6, 6));
        Set<Long> longList=new HashSet<>(Arrays.asList(1000L,600L,214L,0L,0L,540L,358l,600L,484l));
        Set<Float> floatList=new HashSet<>(Arrays.asList(11.0f,22.2f,31.2f,0f,11.0f,31.2f,40.2f,500.3f,6.2f));
        Set<Double> doubleList=new HashSet<>(Arrays.asList(11.0,22.2,31.2,40.2,500.3,0.0,6.2));
        Set<String> stringList=new HashSet<>(Arrays.asList("alagu","siva","bala","siva","abc"));
        Set<Character> characterList=new HashSet<>(Arrays.asList('a','c','z','f','d','z','z'));
